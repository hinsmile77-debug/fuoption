"""주문 상태머신 — 마흐디(선행 옵션 프로젝트) mahdi/broker/order_state_machine.py에서
2026-07-21 이식 (변경 없음, 브로커/설정 의존성이 없어 그대로 포팅).
...
class OrderStateMachine:
    """단일 주문의 상태 전이를 강제하는 헬퍼.

    영속화(execution_logs 반영)는 호출측(Data Layer) 책임.
    """
